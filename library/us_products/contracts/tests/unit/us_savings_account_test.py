...
CONTRACT_FILE = "library/us_products/contracts/us_savings_account.py"
...
class SavingsAccountTest(SavingsAccountBaseTest):
    def test_execution_schedules_update_to_last_valid_day_of_month(self):
        ...
        mock_vault.amend_schedule.assert_called_with(
            event_type="APPLY_ACCRUED_INTEREST", new_schedule=expected_schedule
        )
    ...
    def test_scheduled_code_accrue_interest_with_payable_and_receivable_tiered_interest(
        ...
        mock_vault.make_internal_transfer_instructions.assert_has_calls(
            [
                call(
                    ...
                    denomination=DEFAULT_DENOMINATION,
                    client_transaction_id="ACCRUE_INTEREST_CUSTOMER_TIER2_MOCK_HOOK_ACCRUED"
                    "_INTEREST_PAYABLE_COMMERCIAL_BANK_MONEY_USD",
                ...
                call(
                    amount=Decimal("4.06849"),
                    denomination=DEFAULT_DENOMINATION,
                    client_transaction_id="ACCRUE_INTEREST_GL_TIER2_MOCK_HOOK_ACCRUED_INTEREST"
                    "_PAYABLE_COMMERCIAL_BANK_MONEY_USD",
                ...
                call(
                    amount=Decimal("4.06849"),
                    denomination=DEFAULT_DENOMINATION,
                    client_transaction_id="ACCRUE_INTEREST_CUSTOMER_TIER3_MOCK_HOOK_ACCRUED"
                    "_INTEREST_RECEIVABLE_COMMERCIAL_BANK_MONEY_USD",
                    from_account_id="Main account",
                ...
                call(
                    amount=Decimal("4.06849"),
                    denomination=DEFAULT_DENOMINATION,
                    client_transaction_id="ACCRUE_INTEREST_GL_TIER3_MOCK_HOOK_ACCRUED_INTEREST"
                    "_RECEIVABLE_COMMERCIAL_BANK_MONEY_USD",
        ...
        mock_vault.instruct_posting_batch.assert_called_with(
            posting_instructions=[
                "ACCRUE_INTEREST_CUSTOMER_TIER2_MOCK_HOOK_ACCRUED_INTEREST"
                "_PAYABLE_COMMERCIAL_BANK_MONEY_USD",
                "ACCRUE_INTEREST_GL_TIER2_MOCK_HOOK_ACCRUED_INTEREST"
                "_PAYABLE_COMMERCIAL_BANK_MONEY_USD",
                "ACCRUE_INTEREST_CUSTOMER_TIER3_MOCK_HOOK_ACCRUED_INTEREST"
                "_RECEIVABLE_COMMERCIAL_BANK_MONEY_USD",
                "ACCRUE_INTEREST_GL_TIER3_MOCK_HOOK_ACCRUED_INTEREST_RECEIVABLE"
                "_COMMERCIAL_BANK_MONEY_USD",
            ],
    ...
    def test_interest_applies_when_exceeding_available_balance(self):
        ...
        mock_vault.make_internal_transfer_instructions.assert_has_calls(
            [
                call(
                    ...
                    client_transaction_id="APPLY_INTEREST_CUSTOMER_MOCK_HOOK"
                    "_ACCRUED_INTEREST_RECEIVABLE_COMMERCIAL_BANK_MONEY_USD",
                    instruction_details={
                ...
                call(
                    ...
                    to_account_address="DEFAULT",
                    client_transaction_id="APPLY_INTEREST_GL_MOCK_HOOK"
                    "_ACCRUED_INTEREST_RECEIVABLE_COMMERCIAL_BANK_MONEY_USD",
                    instruction_details={
                        "description": "Interest Applied.",
                        "event": "APPLY_ACCRUED_INTEREST",
        ...
        mock_vault.instruct_posting_batch.assert_called_with(
            ...
            posting_instructions=[
                "APPLY_INTEREST_CUSTOMER_MOCK_HOOK"
                "_ACCRUED_INTEREST_RECEIVABLE_COMMERCIAL_BANK_MONEY_USD",
                "APPLY_INTEREST_GL_MOCK_HOOK"
                "_ACCRUED_INTEREST_RECEIVABLE_COMMERCIAL_BANK_MONEY_USD",
            ],
            effective_date=DEFAULT_DATE,
        )
    ...
    def test_scheduled_code_apply_accrued_interest_with_remainder_creates_reverse(
        ...
        for input_row in input_data:
            ...
            remainder_transaction_id = (
                f"{remainder_prefix}_INTEREST_{{}}_MOCK_HOOK"
            ...
            mock_vault.make_internal_transfer_instructions.assert_has_calls(
                [
                    call(
                        ...
                        client_transaction_id=f"APPLY_INTEREST_CUSTOMER_MOCK_HOOK_"
                        f"ACCRUED_INTEREST_{interest_type}_COMMERCIAL_BANK_MONEY_USD",
                        instruction_details={
                            "event": "APPLY_ACCRUED_INTEREST",
                            "description": "Interest Applied.",
                        },
                    ...
                    call(
                        ...
                        to_account_address="DEFAULT",
                        client_transaction_id=f"APPLY_INTEREST_GL_MOCK_HOOK"
                        f"_ACCRUED_INTEREST_{interest_type}_COMMERCIAL_BANK_MONEY_USD",
                        instruction_details={
                            "event": "APPLY_ACCRUED_INTEREST",
                            "description": "Interest Applied.",
                    ...
                    call(
                        ...
                        client_transaction_id=remainder_transaction_id.format("CUSTOMER"),
                        instruction_details={
                            "event": "APPLY_ACCRUED_INTEREST",
                    ...
                    call(
                        ...
                        to_account_address="DEFAULT",
                        client_transaction_id=remainder_transaction_id.format("GL"),
                        instruction_details={
                            "event": "APPLY_ACCRUED_INTEREST",
                            "description": "Zero out remainder after accrued interest applied.",
                        },
            ...
            mock_vault.instruct_posting_batch.assert_called_with(
                client_batch_id="APPLY_ACCRUED_INTEREST_MOCK_HOOK_USD",
                posting_instructions=[
                    f"APPLY_INTEREST_CUSTOMER_MOCK_HOOK"
                    f"_ACCRUED_INTEREST_{interest_type}_COMMERCIAL_BANK_MONEY_USD",
                    f"APPLY_INTEREST_GL_MOCK_HOOK"
                    f"_ACCRUED_INTEREST_{interest_type}_COMMERCIAL_BANK_MONEY_USD",
                    remainder_transaction_id.format("CUSTOMER"),
                    remainder_transaction_id.format("GL"),
                ],
    ...
    def test_scheduled_code_apply_accrue_interest_with_small_accrue_interest(self):
        ...
        mock_vault.make_internal_transfer_instructions.assert_has_calls(
            [
                call(
                    ...
                    to_account_id="Main account",
                    to_account_address="ACCRUED_INTEREST_RECEIVABLE",
                    client_transaction_id="REVERSE_ACCRUED_INTEREST_CUSTOMER_MOCK_HOOK"
                    "_ACCRUED_INTEREST_RECEIVABLE_COMMERCIAL_BANK_MONEY_USD",
                    instruction_details={
                        "event": "APPLY_ACCRUED_INTEREST",
                        "description": "Zero out remainder after accrued interest applied.",
                ...
                call(
                    ...
                    to_account_id=ACCRUED_INTEREST_RECEIVABLE_ACCOUNT,
                    to_account_address="DEFAULT",
                    client_transaction_id="REVERSE_ACCRUED_INTEREST_GL_MOCK_HOOK"
                    "_ACCRUED_INTEREST_RECEIVABLE_COMMERCIAL_BANK_MONEY_USD",
                    instruction_details={
                        "event": "APPLY_ACCRUED_INTEREST",
                        "description": "Zero out remainder after accrued interest applied.",
        ...
        mock_vault.instruct_posting_batch.assert_called_with(
            client_batch_id="APPLY_ACCRUED_INTEREST_MOCK_HOOK_USD",
            posting_instructions=[
                "REVERSE_ACCRUED_INTEREST_CUSTOMER_MOCK_HOOK"
                "_ACCRUED_INTEREST_RECEIVABLE_COMMERCIAL_BANK_MONEY_USD",
                "REVERSE_ACCRUED_INTEREST_GL_MOCK_HOOK"
                "_ACCRUED_INTEREST_RECEIVABLE_COMMERCIAL_BANK_MONEY_USD",
            ],
            effective_date=start_of_day,
        )
    ...
    def test_close_code_reverses_accrued_interest(self):
        ...
        for (
            ...
            mock_vault.instruct_posting_batch.assert_called_with(
                ...
                posting_instructions=[
                    f"REVERSE_ACCRUED_INTEREST_CUSTOMER_MOCK_HOOK_"
                    f"ACCRUED_INTEREST_{interest_type}_COMMERCIAL_BANK_MONEY_USD",
                    f"REVERSE_ACCRUED_INTEREST_GL_MOCK_HOOK_"
                    f"ACCRUED_INTEREST_{interest_type}_COMMERCIAL_BANK_MONEY_USD",
                ],
    ...
    def test_account_monthly_maintenance_fee_not_applied_if_zero(self):
        ...
        mock_vault = self.create_mock(
            balance_ts=balance_ts,
            denomination="USD",
            account_tier_names=json_dumps(["US_SAVINGS_ACCOUNT_TIER_LOWER"]),
            maintenance_fee_monthly=json_dumps(
                {"US_SAVINGS_ACCOUNT_TIER_LOWER": str(input_maintenance_fee)}
            ),
    ...
    def test_monthly_maintenance_fee_not_applied_if_automated_deposit_transfer(self):
        ...
        mock_vault = self.create_mock(
            ...
            account_tier_names=json_dumps(["US_SAVINGS_ACCOUNT_TIER_LOWER"]),
            maintenance_fee_monthly=json_dumps(
                {"US_SAVINGS_ACCOUNT_TIER_LOWER": str(expected_maintenance_fee)}
            ),
            fees_application_day=1,
            fees_application_hour=0,
            fees_application_minute=0,
    ...
    def test_account_annual_maintenance_fee_applied(self):
        default_committed = Decimal("10000")
        input_maintenance_fee = Decimal("10")
        balance_ts = self.account_balances(DEFAULT_DATE, default_committed=default_committed)
        mock_vault = self.create_mock(
            balance_ts=balance_ts,
            denomination="USD",
            maintenance_fee_annual=input_maintenance_fee,
            fees_application_day=1,
            fees_application_hour=0,
            fees_application_minute=0,
            fees_application_second=0,
        ...
        mock_vault.make_internal_transfer_instructions.assert_called_with(
            ...
            asset=DEFAULT_ASSET,
            override_all_restrictions=True,
            client_transaction_id=f"INTERNAL_POSTING_APPLY_MAINTENANCE_FEE_ANNUAL_MOCK_HOOK"
            f"_{DEFAULT_DENOMINATION}",
            instruction_details={
                "description": "Maintenance fee annual",
                "event": "APPLY_MAINTENANCE_FEE_ANNUAL",
            },
        )

        mock_vault.instruct_posting_batch.assert_called_with(
            posting_instructions=["INTERNAL_POSTING_APPLY_MAINTENANCE_FEE_ANNUAL_MOCK_HOOK_USD"],
            effective_date=DEFAULT_DATE,
        )
    ...
    def test_balance_fee_not_applied_if_mean_balance_above_threshold(self):
        ...
        account_tier_flags = ["US_SAVINGS_ACCOUNT_TIER_LOWER"]
        ...
        mock_vault = self.create_mock(
            ...
            account_tier_names=json_dumps(["US_SAVINGS_ACCOUNT_TIER_LOWER"]),
            maintenance_fee_monthly=json_dumps({"US_SAVINGS_ACCOUNT_TIER_LOWER": str(Decimal(0))}),
            fees_application_day=1,
            fees_application_hour=0,
            fees_application_minute=0,
            fees_application_second=0,
    ...
    def test_extracting_tiered_param_no_flag_on_account_returns_last_tier(self):
        ...
        self.assertEqual(result, "US_SAVINGS_ACCOUNT_TIER_LOWER")

    def test_extracting_tiered_param_one_flag_on_account(self):
        default_committed = Decimal("0")
        account_tier_flags = ["US_SAVINGS_ACCOUNT_TIER_MIDDLE"]
        period_start = datetime(2020, 8, 1)
        balance_ts = self.account_balances(dt=period_start, default_committed=default_committed)
        ...
        result = self.run_function("_get_account_tier", mock_vault, mock_vault)
        self.assertEqual(result, "US_SAVINGS_ACCOUNT_TIER_MIDDLE")
    ...
    def test_extracting_tiered_param_multiple_flags_on_account_returns_first(self):
        ...
        result = self.run_function("_get_account_tier", mock_vault, mock_vault)
        self.assertEqual(result, "US_SAVINGS_ACCOUNT_TIER_UPPER")
    ...
    def test_scheduled_code_accrue_interest_with_promotional_tiered_interest(self):
        ...
        mock_vault.make_internal_transfer_instructions.assert_has_calls(
            [
                call(
                    ...
                    denomination=DEFAULT_DENOMINATION,
                    client_transaction_id="ACCRUE_INTEREST_CUSTOMER_TIER1_MOCK_HOOK_ACCRUED"
                    "_INTEREST_RECEIVABLE_COMMERCIAL_BANK_MONEY_USD",
                    from_account_id="Main account",
                    from_account_address="ACCRUED_INTEREST_RECEIVABLE",
                    to_account_id="Main account",
                ...
                call(
                    amount=Decimal("1.36986"),
                    denomination=DEFAULT_DENOMINATION,
                    client_transaction_id="ACCRUE_INTEREST_GL_TIER1_MOCK_HOOK_ACCRUED_INTEREST"
                    "_RECEIVABLE_COMMERCIAL_BANK_MONEY_USD",
                    from_account_id=ACCRUED_INTEREST_RECEIVABLE_ACCOUNT,
                    from_account_address="DEFAULT",
                    to_account_id=INTEREST_RECEIVED_ACCOUNT,
        ...
        mock_vault.instruct_posting_batch.assert_called_with(
            posting_instructions=[
                "ACCRUE_INTEREST_CUSTOMER_TIER1_MOCK_HOOK_ACCRUED_INTEREST"
                "_RECEIVABLE_COMMERCIAL_BANK_MONEY_USD",
                "ACCRUE_INTEREST_GL_TIER1_MOCK_HOOK_ACCRUED_INTEREST"
                "_RECEIVABLE_COMMERCIAL_BANK_MONEY_USD",
                "ACCRUE_INTEREST_CUSTOMER_TIER3_MOCK_HOOK_ACCRUED_INTEREST"
                "_PAYABLE_COMMERCIAL_BANK_MONEY_USD",
                "ACCRUE_INTEREST_GL_TIER3_MOCK_HOOK_ACCRUED_INTEREST"
                "_PAYABLE_COMMERCIAL_BANK_MONEY_USD",
            ],
            effective_date=end_of_day,
        )
