...
PROMOTION_RATES = json.dumps(
    {
        "US_SAVINGS_ACCOUNT_TIER_UPPER": {"tier1": "0.04", "tier2": "0.03"},
        "US_SAVINGS_ACCOUNT_TIER_MIDDLE": {"tier1": "0.03", "tier2": "0.02"},
        "US_SAVINGS_ACCOUNT_TIER_LOWER": {"tier1": "0.25", "tier2": "-0.01"},
    }
)
...
class USSavingsAccountTest(SimulationTestCase):
    ...
    def test_interest_rates_promotion(self):
        ...
        template_params["maximum_daily_deposit"] = "0"
        template_params["maximum_balance"] = "0"
        template_params["maximum_daily_withdrawal"] = "0"
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    ...
                    + timedelta(days=1, hours=1): {
                        ...
                        INTEREST_PAID_ACCOUNT: [(BalanceDimensions(denomination="USD"), "6.12329")],
    ...
    def test_monthly_maintenance_fee(self):
        ...
        template_params["maximum_balance"] = "0"
        template_params["maximum_daily_withdrawal"] = "0"
        template_params["tiered_interest_rates"] = ZERO_TIERED_INTEREST_RATES
        template_params["maintenance_fee_monthly"] = json.dumps(
            {"US_SAVINGS_ACCOUNT_TIER_LOWER": "20"}
        )
        template_params["promotional_maintenance_fee_monthly"] = json.dumps(
    ...
    def test_live_max_balance(self):
        ...
        On day 11, a backdated depsit $5 is made with a value timestamp day 9
        ...
        template_params = self.default_template_params.copy()
        template_params["minimum_deposit"] = "5"
        ...
        sub_tests = [
            SubTest(
                ...
                expected_balances_at_ts={
                        ...
                        INTEREST_PAID_ACCOUNT: [(BalanceDimensions(denomination="USD"), "0.40822")],
                    }
                },
            ),
        ]
    ...
    def test_interest_accrual_no_balance_ranges(self):
        ...
        template_params = self.default_template_params.copy()
        template_params["balance_tier_ranges"] = json.dumps({"tier1": {"min": "0"}})
        template_params["tiered_interest_rates"] = json.dumps(
            {
                "US_SAVINGS_ACCOUNT_TIER_UPPER": {"tier1": "0.02"},
                "US_SAVINGS_ACCOUNT_TIER_MIDDLE": {"tier1": "0.0125"},
                "US_SAVINGS_ACCOUNT_TIER_LOWER": {"tier1": "0.1"},
            }
        )
        template_params["maximum_daily_deposit"] = "0"
        template_params["maximum_balance"] = "0"
        ...
        sub_tests = [
            SubTest(
                ...
                expected_balances_at_ts={
                        ...
                        INTEREST_PAID_ACCOUNT: [(BalanceDimensions(denomination="USD"), "5.47945")],
                    }
                },
            ),
        ]
    ...
    def test_deposit_scenarios(self):
        ...
        fifthteenth_day = start + timedelta(days=14, hours=1)
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                + [
                    create_inbound_hard_settlement_instruction(
                        ...
                        target_account_id="Main account",
                        internal_account_id="1",
                        event_datetime=fifthteenth_day,
                    ),
                ],
                expected_posting_rejections=[
                    ExpectedRejection(
                        timestamp=fifthteenth_day,
                        rejection_type="AgainstTermsAndConditions",
                        rejection_reason="Posting would cause the maximum balance to be exceeded.",
                    )
                ],
            ...
            SubTest(
                description=(
                    "check accurals are still applied at max deposit amount, and deposits are "
                    "still rejected"
                ),
                events=[
                    create_inbound_hard_settlement_instruction(
    ...
    def test_withdrawal_scenarios(self):
        ...
        template_params["minimum_withdrawal"] = "5"
        template_params["tiered_interest_rates"] = ZERO_TIERED_INTEREST_RATES
        instance_params = self.default_instance_params.copy()
        instance_params["interest_application_day"] = "28"
    ...
    def test_schedules(self):
        ...
        template_params["fees_application_hour"] = "4"
        template_params["fees_application_minute"] = "5"
        template_params["fees_application_second"] = "6"
    ...
    def test_schedules_when_lt_period_from_creation(self):
        ...
        template_params = self.default_template_params.copy()
        template_params["fees_application_day"] = "1"
        template_params["fees_application_hour"] = "0"
        template_params["fees_application_minute"] = "1"
        template_params["fees_application_second"] = "0"
        ...
        apply_annual_fees_datetime_when_lt_period_fr_creation = [
            datetime(
                year=2021,
                month=2,
                day=1,
        ...
        sub_tests = [
            SubTest(
                ...
                expected_schedules=[
                    ...
                    ExpectedSchedule(
                        run_times=apply_annual_fees_datetime_when_lt_period_fr_creation,
                        count=1,
                        event_id="APPLY_ANNUAL_FEES",
                        account_id="Main account",
                    ),
    ...
    def test_schedules_with_changing_interest_application_frequency(self):
        ...
        template_params = self.default_template_params.copy()
        template_params["interest_application_frequency"] = "quarterly"
        instance_params = self.default_instance_params.copy()
        instance_params["interest_application_day"] = "28"

        quartlerly_interest_applications = self._create_list_of_schedule_datetimes(
            start=datetime(
                year=2019,
                month=4,
                day=28,
        ...
        sub_tests = [
            SubTest(
                ...
                expected_schedules=[
                    ExpectedSchedule(
                        run_times=quartlerly_interest_applications,
                        count=len(quartlerly_interest_applications),
                        event_id="APPLY_ACCRUED_INTEREST",
                        account_id="Main account",
                    ),
                ],
    ...
    def test_minimum_average_balance(self):
        ...
        template_params = self.default_template_params.copy()
        template_params["interest_application_frequency"] = "quarterly"
        template_params["minimum_balance_fee"] = "10"
        template_params["tiered_interest_rates"] = ZERO_TIERED_INTEREST_RATES
    ...
    def test_minimum_average_balance_flag_tiers(self):
        ...
        template_params["minimum_balance_fee"] = "10"
        template_params["minimum_balance_fee"] = "10"
        template_params["account_tier_names"] = json.dumps(["X", "Y", "Z"])
        template_params["tiered_minimum_balance_threshold"] = json.dumps(
            {"X": "10", "Y": "100", "Z": "200"}
        )
        template_params["tiered_interest_rates"] = json.dumps(
            {
        ...
        template_params["maintenance_fee_monthly"] = json.dumps({"X": "0", "Y": "0", "Z": "0"})
    ...
    def test_excess_withdrawal_limit(self):
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                expected_workflows=[
                    ExpectedWorkflow(
                        workflow_definition_id="US_PRODUCTS_TRANSACTION_LIMIT_WARNING",
                        account_id="Main account",
