...
class USCheckingAccountTest(SimulationTestCase):
    ...
    contract_filepaths = CONTRACT_FILES
    contract_modules = [
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    ...
                    + timedelta(days=1, hours=1): {
                        ...
                        INTEREST_PAID_ACCOUNT: [(BalanceDimensions(denomination="USD"), "0.41096")],
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    ...
                    + timedelta(days=2, hours=2): {
                        ...
                        INTEREST_PAID_ACCOUNT: [(BalanceDimensions(denomination="USD"), "0.61631")],
                        ACCRUED_INTEREST_RECEIVABLE_ACCOUNT: [
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    ...
                    + timedelta(days=3, hours=2): {
                        ...
                        INTEREST_PAID_ACCOUNT: [(BalanceDimensions(denomination="USD"), "0.82110")],
                        ACCRUED_INTEREST_RECEIVABLE_ACCOUNT: [
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    ...
                    + timedelta(days=4, hours=2): {
                        ...
                        INTEREST_PAID_ACCOUNT: [(BalanceDimensions(denomination="USD"), "1.02932")],
                        ACCRUED_INTEREST_RECEIVABLE_ACCOUNT: [
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    before_1st_interest_application: {
                        ...
                        INTEREST_PAID_ACCOUNT: [(BalanceDimensions(denomination="USD"), "6.65126")],
                        ACCRUED_INTEREST_RECEIVABLE_ACCOUNT: [
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    before_2nd_interest_application: {
                        ...
                        INTEREST_RECEIVED_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "16.00645")
                        ],
                    },
    ...
    def test_overdraft_interest_accrual_application_and_fees(self):
        ...
        before_3rd_monthly_fee = datetime(year=2020, month=4, day=1, tzinfo=timezone.utc)
        after_3rd_monthly_fee = before_3rd_monthly_fee + timedelta(minutes=2)

        sub_tests = [
            SubTest(
                description="overdraft remainder is discarded",
                events=[
                    create_outbound_hard_settlement_instruction(
                ...
                expected_balances_at_ts={
                    before_1st_monthly_fee: {
                        "Main account": [
                            (BalanceDimensions(denomination="USD"), "-450.00"),
                            # 2020 is a leap year but note that 'interest_accrual_days_in_year'
                            # is set to 365
                            # daily accrual = 0.1485 / 365 * (-450 + 50 buffer) = -0.16274
                            # total overdraft accrual = -0.16274 * 31 = -5.04494
                            # total accrued_overdraft fee = 0 (1000 loc fee free limit)
                            (
                                BalanceDimensions(
                        ...
                        ACCRUED_INTEREST_RECEIVABLE_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "5.04494"),
                        ],
                        INTEREST_RECEIVED_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "5.04494"),
                        ],
                    ...
                    after_1st_monthly_fee: {
                        "Main account": [
                            (BalanceDimensions(denomination="USD"), "-455.04"),
                            (
                                BalanceDimensions(
                                    address="ACCRUED_OVERDRAFT_RECEIVABLE",
                                    denomination="USD",
                        ...
                        INTEREST_RECEIVED_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "5.04"),
                        ],
                    },
                },
            ),
            SubTest(
                ...
                expected_balances_at_ts={
                    ...
                    + timedelta(days=1, hours=1): {
                        "Main account": [
                            (BalanceDimensions(denomination="USD"), "-1955.04"),
                            # 2020 is a leap year but note that 'interest_accrual_days_in_year'
                            # is set to 365
                            # daily accrual = 0.1485 / 365 * (-1955.04 + 50 buffer) = -0.77506
                            # total overdraft accrual = -0.77506
                            # total accrued overdraft fee = 5
                            # total received interest = 5.04 + 0.77506 = 5.81506
                            (
                                BalanceDimensions(
                                    address="ACCRUED_OVERDRAFT_FEE_RECEIVABLE",
                                    denomination="USD",
                        ...
                        ACCRUED_INTEREST_RECEIVABLE_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "0.77506"),
                        ],
                        INTEREST_RECEIVED_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "5.81506"),
                        ],
                        OVERDRAFT_FEE_RECEIVABLE_ACCOUNT: [
                    ...
                    + timedelta(days=7, hours=1): {
                        "Main account": [
                            (BalanceDimensions(denomination="USD"), "-1955.04"),
                            # total overdraft accrual = -0.77506 * 7 = -5.42542
                            # total accrued overdraft fee = 5 * 7 = 35
                            # total received interest = 5.04 + 5.42542 = 10.46542
                            (
                                BalanceDimensions(
                                    address="ACCRUED_OVERDRAFT_FEE_RECEIVABLE",
                                    denomination="USD",
                        ...
                        ACCRUED_INTEREST_RECEIVABLE_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "5.42542"),
                        ],
                        INTEREST_RECEIVED_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "10.46542"),
                        ],
                        OVERDRAFT_FEE_RECEIVABLE_ACCOUNT: [
            ...
            SubTest(
                description="overdraft interest rate with actual days in year",
                events=[
                    create_template_parameter_change_event(
                        timestamp=after_1st_monthly_fee + timedelta(days=7, hours=2),
                        interest_accrual_days_in_year="actual",
                    )
                ],
                # daily accrual = 0.1485 / 366 * (-1955.04 + 50 buffer) = -0.77295
                # total overdraft accrual = -5.42542 + -0.77295 = -6.19837
                # total received interest = 10.46542 + 0.77295 = 11.23837
                expected_balances_at_ts={
                    after_1st_monthly_fee
                    + timedelta(days=8, hours=1): {
                        "Main account": [
                            (BalanceDimensions(denomination="USD"), "-1955.04"),
                            (
                                BalanceDimensions(
                        ...
                        ACCRUED_INTEREST_RECEIVABLE_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "6.19837"),
                        ],
                        INTEREST_RECEIVED_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "11.23837"),
                        ],
                        OVERDRAFT_FEE_RECEIVABLE_ACCOUNT: [
            ...
            SubTest(
                description="overdraft interest rate with 360 days in year",
                events=[
                    create_template_parameter_change_event(
                        timestamp=after_1st_monthly_fee + timedelta(days=8, hours=2),
                        interest_accrual_days_in_year="360",
                    )
                ],
                # daily accrual = 0.1485 / 360 * (-1955.04 + 50 buffer) = -0.78583
                # total overdraft accrual = -6.19837 + -0.78583 = -6.9842
                # total received interest = 11.23837 + 0.78583 = 12.0242
                expected_balances_at_ts={
                    after_1st_monthly_fee
                    + timedelta(days=9, hours=1): {
                        "Main account": [
                            (BalanceDimensions(denomination="USD"), "-1955.04"),
                            (
                                BalanceDimensions(
                        ...
                        ACCRUED_INTEREST_RECEIVABLE_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "6.98420"),
                        ],
                        INTEREST_RECEIVED_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "12.0242"),
                        ],
                        OVERDRAFT_FEE_RECEIVABLE_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "45"),
                        ],
                        OVERDRAFT_FEE_INCOME_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "45"),
                        ],
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    # overdraft fees capped at 80, interest accrual excludes overdraft fees
                    # daily accrual = 0.1485 / 360 * (-1955.04 + 50 buffer) = -0.78583
                    # total overdraft accrual = -6.98420 + (-0.78583 * 20) = -22.7008
                    # total received interest = 12.0242 + 16.50243 = 27.7408
                    before_2nd_monthly_fee: {
                        ...
                        ACCRUED_INTEREST_RECEIVABLE_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "22.7008"),
                        ],
                        INTEREST_RECEIVED_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "27.7408"),
                        ],
                        OVERDRAFT_FEE_RECEIVABLE_ACCOUNT: [
                    ...
                    after_2nd_monthly_fee: {
                        "Main account": [
                            (BalanceDimensions(denomination="USD"), "-2057.74"),
                            (
                                BalanceDimensions(
                                    address="ACCRUED_OVERDRAFT_FEE_RECEIVABLE",
                                    denomination="USD",
                        ...
                        INTEREST_RECEIVED_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "27.74"),
                        ],
                        OVERDRAFT_FEE_RECEIVABLE_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "0.00"),
                        ],
            ...
            SubTest(
                description="overdraft interest based on EoD balance, not maximum during the day",
                events=[
                    create_template_parameter_change_event(
                        timestamp=after_2nd_monthly_fee + timedelta(minutes=1),
                        interest_accrual_days_in_year="365",
                    ),
                    # resets balance to 0
                    create_inbound_hard_settlement_instruction(
                        "2057.74",
                        after_2nd_monthly_fee + timedelta(hours=1),
                        denomination="USD",
                    ),
                    create_outbound_hard_settlement_instruction(
                        "400.00",
                        after_2nd_monthly_fee + timedelta(hours=2),
                        denomination="USD",
                    ),
                    create_inbound_hard_settlement_instruction(
                        "100.00",
                        after_2nd_monthly_fee + timedelta(hours=3),
                        denomination="USD",
                    ),
                    create_outbound_hard_settlement_instruction(
                        "200.00",
                        after_2nd_monthly_fee + timedelta(hours=4),
                        denomination="USD",
                    ),
                    create_inbound_hard_settlement_instruction(
                        "200.00",
                        after_2nd_monthly_fee + timedelta(hours=5),
                        denomination="USD",
                    ),
                ],
                expected_balances_at_ts={
                    ...
                    + timedelta(days=1, hours=1): {
                        "Main account": [
                            (BalanceDimensions(denomination="USD"), "-300.00"),
                            # daily accrual = 0.1485 / 365 * (-300 + 50 buffer) = -0.10171
                            # total overdraft accrual = -0.10171
                            # total received interest = 27.74 + 0.10171 = 27.84171
                            (
                                BalanceDimensions(
                                    address="ACCRUED_OVERDRAFT_RECEIVABLE",
                                    denomination="USD",
                        ...
                        ACCRUED_INTEREST_RECEIVABLE_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "0.10171"),
                        ],
                        INTEREST_RECEIVED_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "27.84171"),
                        ],
                    }
                },
            ),
            SubTest(
                description="positive balance does not incur further overdraft interest",
                events=[
                    create_inbound_hard_settlement_instruction(
                        "500.00",
                        after_2nd_monthly_fee + timedelta(days=1, hours=5),
                        denomination="USD",
                    )
                ],
                expected_balances_at_ts={
                    ...
                    + timedelta(days=2, hours=1): {
                        "Main account": [
                            ...
                            # daily deposit accrual = 0.05 / 365 * (500 - 300) = 0.02740
                            # total payed interest = 0.02740
                            (
                                BalanceDimensions(
                                    address="ACCRUED_DEPOSIT_PAYABLE",
                                    denomination="USD",
                        ...
                        ACCRUED_INTEREST_PAYABLE_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "0.02740"),
                        ],
            ...
            SubTest(
                description="within overdraft buffer does not incur further overdraft interest",
                events=[
                    create_outbound_hard_settlement_instruction(
                        "250.00",
                        after_2nd_monthly_fee + timedelta(days=2, hours=5),
                        denomination="USD",
                    )
                ],
                expected_balances_at_ts={
                    ...
                    + timedelta(days=3, hours=1): {
                        "Main account": [
                            (BalanceDimensions(denomination="USD"), "-50.00"),
                            (
                                BalanceDimensions(
                                    address="ACCRUED_DEPOSIT_PAYABLE",
                                    denomination="USD",
            ...
            SubTest(
                description="interest applicatioin with overdraft and deposit",
                expected_balances_at_ts={
                    before_3rd_monthly_fee: {
                        "Main account": [
                            (BalanceDimensions(denomination="USD"), "-50.00"),
                            (
                                BalanceDimensions(
                    ...
                    after_3rd_monthly_fee: {
                        "Main account": [
                            (BalanceDimensions(denomination="USD"), "-50.07"),
                            (
                                BalanceDimensions(
                                    address="ACCRUED_DEPOSIT_PAYABLE",
                                    denomination="USD",
                        ...
                        INTEREST_RECEIVED_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "27.84"),
                        ],
                        ACCRUED_INTEREST_PAYABLE_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "0.00"),
                        ],
                        INTEREST_PAID_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "0.03"),
                        ],
                    },
                },
            ),
    ...
    def test_maintenance_fees(self):
        start = datetime(year=2021, month=1, day=1, tzinfo=timezone.utc)
        end = datetime(year=2022, month=2, day=1, tzinfo=timezone.utc)

        template_params = self.default_template_params.copy()
        template_params["maintenance_fee_monthly"] = dumps({"US_CHECKING_ACCOUNT_TIER_LOWER": "10"})
        template_params["promotional_maintenance_fee_monthly"] = dumps(
            {"US_CHECKING_ACCOUNT_TIER_LOWER": "5"}
        )
        template_params["fees_application_day"] = "31"
        template_params["fees_application_hour"] = "17"
        template_params["fees_application_minute"] = "30"
        template_params["fees_application_second"] = "30"

        template_params["maintenance_fee_annual"] = "75"
        ...
        (
            before_annual_fee_application,
            after_annual_fee_application,
        ) = _get_last_day_of_month_fee_application(2022, 1)
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    # increase deposit threshold to single out minimum balance threhold criterion
                    create_template_parameter_change_event(
            ...
            SubTest(
                description="monthly maintenance fees applied for subsequent 4 months",
                expected_balances_at_ts={
                    before_annual_fee_application: {
                        "Main account": [
                            (BalanceDimensions(denomination="USD"), "1350.00"),
                        ],
                        MAINTENANCE_FEE_INCOME_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "85.00"),
                        ],
                    }
                },
            ),
            SubTest(
                description="annual maintenance fee and monthly fee are applied at configured time",
                expected_balances_at_ts={
                    after_annual_fee_application: {
                        "Main account": [
                            (BalanceDimensions(denomination="USD"), "1265"),
                        ],
                        MAINTENANCE_FEE_INCOME_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "95.00"),
                        ],
                        ANNUAL_MAINTENANCE_FEE_INCOME_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "75.00"),
                        ],
                    }
                },
            ),
    ...
    def test_minimum_balance_fee(self):
        ...
        template_params = self.default_template_params.copy()
        template_params["minimum_balance_fee"] = "100"
        template_params["tier_names"] = dumps(["X", "Y", "Z"])
        template_params["minimum_balance_threshold"] = dumps({"X": "100", "Y": "300", "Z": "500"})
        template_params["maintenance_fee_monthly"] = dumps({"X": "0", "Y": "0", "Z": "0"})
        template_params["minimum_combined_balance_threshold"] = dumps(
            {"X": "5000", "Y": "5000", "Z": "5000"}
        )
        template_params["minimum_deposit_threshold"] = dumps({"X": "500", "Y": "500", "Z": "500"})
        template_params["interest_free_buffer"] = dumps({"X": "50", "Y": "50", "Z": "50"})
        template_params["overdraft_interest_free_buffer_days"] = dumps(
            {"X": "7", "Y": "7", "Z": "7"}
        )
        template_params["deposit_tier_ranges"] = dumps({"tier1": {"min": "0"}})
        template_params["deposit_interest_rate_tiers"] = dumps({"tier1": "0.00"})
    ...
    def test_minimum_balance_fee_eod_sampling_time(self):
        ...
        template_params["deposit_tier_ranges"] = dumps({"tier1": {"min": "0"}})
        template_params["deposit_interest_rate_tiers"] = dumps({"tier1": "0.00"})
        template_params["fees_application_hour"] = "23"
        template_params["fees_application_minute"] = "59"
        template_params["fees_application_second"] = "58"
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                description="fluctuaing balance with average below MAB",
                events=[
    ...
    def test_configurable_interest_accrual_and_application_time(self):
        ...
        template_params = self.default_template_params.copy()
        template_params["deposit_tier_ranges"] = dumps({"tier1": {"min": "0"}})
        template_params["deposit_interest_rate_tiers"] = dumps({"tier1": "0.03"})

        template_params["interest_accrual_hour"] = "22"
        template_params["interest_accrual_minute"] = "59"
        template_params["interest_accrual_second"] = "59"

        template_params["interest_application_hour"] = "23"
        template_params["interest_application_minute"] = "59"
        template_params["interest_application_second"] = "1"
        ...
        sub_tests = [
            ...
            SubTest(
                description="overdraft interest application runs at configured time",
                expected_schedules=[
                    ExpectedSchedule(
                        run_times=[
                            datetime(
                        ...
                        event_id="APPLY_ACCRUED_OVERDRAFT_INTEREST",
                        account_id="Main account",
                        count=1,
                    )
                ],
    ...
    def test_interest_application_monthly_only_once_per_month(self):
        ...
        template_params["deposit_tier_ranges"] = dumps({"tier1": {"min": "0"}})
        template_params["deposit_interest_rate_tiers"] = dumps({"tier1": "0.03"})
        template_params["deposit_interest_application_frequency"] = "monthly"
        template_params["interest_application_hour"] = "23"
        template_params["interest_application_minute"] = "59"
        template_params["interest_application_second"] = "59"
        instance_params["interest_application_day"] = "4"
    ...
    def test_interest_application_quarterly(self):
        ...
        template_params["deposit_tier_ranges"] = dumps({"tier1": {"min": "0"}})
        template_params["deposit_interest_rate_tiers"] = dumps({"tier1": "0.03"})
        template_params["deposit_interest_application_frequency"] = "quarterly"
        template_params["interest_application_hour"] = "23"
        template_params["interest_application_minute"] = "59"
        template_params["interest_application_second"] = "59"
        instance_params["interest_application_day"] = "4"
    ...
    def test_interest_application_annually(self):
        ...
        instance_params = self.default_instance_params.copy()
        template_params["deposit_tier_ranges"] = dumps({"tier1": {"min": "0"}})
        template_params["deposit_interest_rate_tiers"] = dumps({"tier1": "0.06"})
        template_params["deposit_interest_application_frequency"] = "annually"
        template_params["interest_application_hour"] = "23"
        template_params["interest_application_minute"] = "59"
        template_params["interest_application_second"] = "59"
        instance_params["interest_application_day"] = "10"
    ...
    def test_schedules(self):
        ...
        template_params = self.default_template_params.copy()
        template_params["fees_application_day"] = "3"
        template_params["fees_application_hour"] = "23"
        template_params["fees_application_minute"] = "59"
        template_params["fees_application_second"] = "59"
        ...
        apply_annual_fees_datetime = self._create_list_of_schedule_datetimes(
            start=datetime(
                year=2020,
                month=1,
                day=3,
        ...
        sub_tests = [
            SubTest(
                ...
                expected_schedules=[
                    ...
                    ExpectedSchedule(
                        run_times=apply_annual_fees_datetime,
                        count=len(apply_annual_fees_datetime),
                        event_id="APPLY_ANNUAL_FEES",
                        account_id="Main account",
                    ),
                ],
            )
    ...
    def test_overdraft_buffer_days(self):
        start = datetime(year=2021, month=1, day=1, tzinfo=timezone.utc)
        end = datetime(year=2021, month=1, day=5, tzinfo=timezone.utc)
        template_params = self.default_template_params.copy()
        template_params["tier_names"] = dumps(["X", "Y", "Z"])
        template_params["interest_free_buffer"] = dumps({"X": "30.00", "Y": "50.00", "Z": "100.00"})
        template_params["overdraft_interest_free_buffer_days"] = dumps(
            {"X": "7", "Y": "3", "Z": "5"}
        )

        after_first_day = start + timedelta(days=1, hours=1)
        after_second_day = start + timedelta(days=2, hours=1)
        after_third_day = start + timedelta(days=3, hours=1)

        one_day_after_buffer_period = start + timedelta(days=4, hours=1)

        sub_tests = [
            SubTest(
                description="overdraft tiered value is correct with single flag",
                events=[
                    create_flag_definition_event(timestamp=start, flag_definition_id="X"),
                    create_flag_definition_event(timestamp=start, flag_definition_id="Y"),
                    create_flag_definition_event(timestamp=start, flag_definition_id="Z"),
                    create_flag_event(
                        timestamp=start,
                        expiry_timestamp=start + timedelta(days=4, hours=2),
                        flag_definition_id="Y",
                        account_id="Main account",
                    ),
                ],
            ...
            SubTest(
                description="within buffer amount and days, no interest accrued",
                events=[
                    create_outbound_hard_settlement_instruction(
                        "30.00", start + timedelta(hours=2), denomination="USD"
                    )
                ],
                expected_balances_at_ts={
                    after_first_day: {
                        "Main account": [
                            ...
                            # TODO current pattern lacks a helper to check no other
                            # addresses has a balance and one should be added in the future
                            # otherwise in case of an address name change, this particular
                            # sub test will still pass in correctly
                            # however, the risk is very low, since all subtests form logical
                            # and chrono steps, so other sub tests within the suite will fail
                            # correctly, prompting refactoring of entire test cases
                            (
                                BalanceDimensions(
                                    address="ACCRUED_OVERDRAFT_RECEIVABLE",
                                    denomination="USD",
            ...
            SubTest(
                description="overdraft using lowest index flag when assigned multiple ones",
                events=[
                    create_flag_event(
                        timestamp=after_first_day,
                        expiry_timestamp=end,
            ...
            SubTest(
                description="within buffer days above buffer amount, interest accrued",
                events=[
                    create_outbound_hard_settlement_instruction(
                        "30.00",
                        after_second_day + timedelta(hours=2),
                        denomination="USD",
                    )
                ],
                # 0.1485 / 365 * 10 = -0.00407
                expected_balances_at_ts={
                    after_third_day: {
                        "Main account": [
                            (BalanceDimensions(denomination="USD"), "-60.00"),
                            (
                                BalanceDimensions(
                                    address="ACCRUED_OVERDRAFT_RECEIVABLE",
                                    denomination="USD",
                        ...
                        ACCRUED_INTEREST_RECEIVABLE_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "0.00407"),
                        ],
                        INTEREST_RECEIVED_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "0.00407"),
                        ],
            ...
            SubTest(
                description="outside buffer days entire overdraft amount accrues interest",
                # 0.1485 / 365 * 60 = -0.02441
                # total accrued = -0.02441 + -0.00407 = -0.02848
                expected_balances_at_ts={
                    one_day_after_buffer_period: {
                        "Main account": [
                            (BalanceDimensions(denomination="USD"), "-60.00"),
                            (
                                BalanceDimensions(
                        ...
                        ACCRUED_INTEREST_RECEIVABLE_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "0.02848"),
                        ],
                        INTEREST_RECEIVED_ACCOUNT: [
                            (BalanceDimensions(denomination="USD"), "0.02848"),
                        ],
            ...
            SubTest(
                description="after flag expiry, overdraft buffer values come from remaining flag Z",
                # buffer amount is now 100 and buffer period 5 days, so no further accrual
                expected_balances_at_ts={
                    end: {
                        "Main account": [
                            (BalanceDimensions(denomination="USD"), "-60.00"),
    ...
    def test_dormancy(self):
        ...
        template_params = self.default_template_params.copy()
        template_params["maintenance_fee_monthly"] = dumps({"US_CHECKING_ACCOUNT_TIER_LOWER": "10"})
        template_params["minimum_balance_fee"] = "15"
        template_params["maintenance_fee_annual"] = "75"
    ...
    def test_auto_save(self):
        ...
        template_params = self.default_template_params.copy()
        template_params["autosave_rounding_amount"] = "1.00"
        instance_params = self.default_instance_params.copy()
        instance_params["autosave_savings_account"] = "test_savings_account"
    ...
    def test_overdraft_transaction_fee(self):
        ...
        template_params = self.default_template_params.copy()
        template_params["standard_overdraft_per_transaction_fee"] = "34"
        template_params["standard_overdraft_daily_fee"] = "1"
        # Set standard_overdraft_fee_cap to 0 to test it is unlimited
        template_params["standard_overdraft_fee_cap"] = "0"
    ...
    def test_standard_overdraft_transaction_coverage(self):
        ...
        template_params = self.default_template_params.copy()
        template_params["standard_overdraft_per_transaction_fee"] = "0"
        template_params["deposit_tier_ranges"] = dumps({"tier1": {"min": "0"}})
        template_params["deposit_interest_rate_tiers"] = dumps({"tier1": "0.00"})
        ...
        sub_tests = [
            SubTest(
                ...
                events=[
                    ...
                    # Attempt to make a withdrawl that would
    ...
    def test_credit_posting_not_rejected_even_if_total_is_over_standard_overdraft_limit(
        ...
        template_params = self.default_template_params.copy()
        template_params["standard_overdraft_per_transaction_fee"] = "5"
