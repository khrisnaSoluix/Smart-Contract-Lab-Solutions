...
class CreditCardInterestTest(SimulationTestCase):
    ...
    def test_transaction_without_interest_free_period_charges_immediately(self):
        ...
        end = offset_datetime(2019, 2, 2, 2)
    ...
    def test_transaction_without_interest_free_period_charges_less_after_repayments(
        ...
        start = offset_datetime(2019, 1, 1)
        end = offset_datetime(2019, 2, 23, 2)
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="3000", event_datetime=offset_datetime(2019, 1, 10, 1)
                    )
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="1000", event_datetime=offset_datetime(2019, 2, 22, 1)
                    )
                ],
            ),
            SubTest(
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="2000",
                        event_datetime=offset_datetime(2019, 2, 1, 3),
                        instruction_details={"transaction_code": "aaa"},
                    )
                ],
            ),
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="5000", event_datetime=offset_datetime(2019, 2, 22, 1)
                    )
                ],
            ),
            SubTest(
    ...
    def test_purchase_interest_accrued_from_scod_is_tracked_at_per_transaction_type(
        ...
        start = offset_datetime(2019, 1, 1)
        end = offset_datetime(2019, 4, 8, 2)
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="2000",
                        event_datetime=offset_datetime(2019, 2, 27, 1),
                    )
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="1000",
                        event_datetime=offset_datetime(2019, 3, 15, 1),
                    )
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="3000",
                        event_datetime=offset_datetime(2019, 3, 30, 1),
                    )
                ],
            ),
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="500",
                        event_datetime=offset_datetime(2019, 3, 31, 1),
                    )
                ],
            ),
            SubTest(
    ...
    def test_purchase_interest_accrued_from_txn_day_is_tracked_at_per_transaction_type(
        ...
        sub_tests = [
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="1000", event_datetime=offset_datetime(2019, 1, 1, 1)
                    )
                ],
            ),
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="399", event_datetime=offset_datetime(2019, 1, 3, 1)
                    )
                ],
            ),
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="100", event_datetime=offset_datetime(2019, 1, 15, 1)
                    )
                ],
            ),
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="900", event_datetime=offset_datetime(2019, 1, 31, 1)
                    )
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="500", event_datetime=offset_datetime(2019, 2, 2, 1)
                    )
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="2000", event_datetime=offset_datetime(2019, 2, 27, 1)
                    )
                ],
            ),
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="1000", event_datetime=offset_datetime(2019, 2, 28, 1)
                    )
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="900", event_datetime=offset_datetime(2019, 3, 2, 1)
                    )
                ],
            ),
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="1000", event_datetime=offset_datetime(2019, 3, 15, 1)
                    )
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="300", event_datetime=offset_datetime(2019, 4, 2, 1)
                    )
                ],
            ),
            SubTest(
    ...
    def test_purchase_and_cash_advance_interest_acc_from_scod_is_tracked_at_per_txn_type(
        ...
        start = offset_datetime(2019, 1, 1)
        end = offset_datetime(2019, 4, 1, 2)
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="1500", event_datetime=offset_datetime(2019, 3, 2, 1)
                    )
                ],
            ),
            SubTest(
    ...
    def test_customer_with_blocking_flag_does_not_accrue(self):
        ...
        start = offset_datetime(2019, 1, 1)
        end = offset_datetime(2019, 1, 7, 0, 1)
        ...
        template_params["accrual_blocking_flags"] = '["90_DPD","CUSTOMER_FLAGGED"]'
            ...
            SubTest(
                ...
                events=[
                    create_flag_definition_event(
                        ...
                        timestamp=offset_datetime(2019, 1, 1),
                    ),
                    create_flag_event(
                        flag_definition_id="90_DPD",
    ...
    def test_cash_withdrawal_eq_positive_balance_purchase_repay_ca_no_interest(self):
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="15000", event_datetime=offset_datetime(2019, 1, 3, 1)
                    )
                ],
                expected_balances_at_ts={
    ...
    def test_cash_withdrawal_eq_positive_balance_purchase_overrepay_ca_interest_accrued(
        ...
        sub_tests = [
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="10000", event_datetime=offset_datetime(2019, 1, 2, 1)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 1, 2, 1): {
    ...
    def test_uncharged_interest_acc_from_scod_reversal(self):
        ...
        template_params["base_interest_rates"] = dumps(
            {"cash_advance": "0.36", "purchase": "0.28", "transfer": "0.28"}
        )
        template_params["annual_percentage_rate"] = dumps(
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="11204.41",
                        event_datetime=offset_datetime(2019, 2, 23, 2),
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 23, 2): {
                        "Main account": [
    ...
    def test_cash_advance_and_interest_on_unpaid_interest_accrued(self):
        ...
        start = offset_datetime(2019, 1, 1)
        end = offset_datetime(2019, 4, 1, 0, 2)
    ...
    def test_charge_interest_acc_from_scod_for_types_with_ref_when_revolver_starts(
        ...
        """
        start = offset_datetime(2019, 1, 1)
        end = offset_datetime(2019, 3, 1)

        instance_params = self.default_instance_params.copy()
        template_params = self.default_template_params.copy()

        instance_params["transaction_references"] = dumps({"balance_transfer": ["REF1"]})
        instance_params["transaction_annual_percentage_rate"] = dumps(
            {"balance_transfer": {"REF1": "0.25"}}
        )
        instance_params["transaction_base_interest_rates"] = dumps(
            {"balance_transfer": {"REF1": "0.22"}}
        )
        instance_params["annual_fee"] = "0"
        ...
        template_params["minimum_percentage_due"] = default_template_update(
    ...
    def test_interest_free_period_unchargd_interest_acc_from_scod_0ed_if_outstanding_bal_paid(
        ...
        Make a purchase and cash advanceafter PDD - verify that these transactions do not accrue
        ...
        """
        start = offset_datetime(2019, 1, 1)
        end = offset_datetime(2019, 3, 26, 1)
        ...
        instance_params["interest_free_expiry"] = dumps(
            {"purchase": "2019-12-31 12:00:00", "cash_advance": "2019-12-31 12:00:00"}
        )
        instance_params["transaction_interest_free_expiry"] = dumps(
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="4210",
                        event_datetime=offset_datetime(2019, 2, 24, 23),
                    )
                ],
            ),
    ...
    def test_interest_free_period_unchrgd_interest_acc_from_scod_0ed_if_mad_paid_and_revolver(
        ...
        Include checks on behaviorial difference caused by charge_interest_from_transaction_date
        """
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="100",
                        event_datetime=offset_datetime(2019, 3, 24, 23),
                    )
                ],
            ),
            # Since MAD was repaid, all uncharged interest free period interest is zeroed out.
            ...
            SubTest(
                ...
                expected_workflows=[
                    ExpectedWorkflow(
                        workflow_definition_id=EXPIRE_INTEREST_FREE_PERIODS_WORKFLOW,
                        count=0,
                    )
                ],
            ),
    ...
    def test_interest_free_period_expired_and_charged_if_mad_not_repaid_int_acc_from_scod(
        ...
        Verify that the interest accrued under the INTEREST_FREE_POERIOD_INTEREST_UNCHARGED address
        ...
        instance_params["annual_fee"] = "0"
        instance_params["credit_limit"] = "10000"
        instance_params["interest_free_expiry"] = dumps({"purchase": "2019-12-31 12:00:00"})
        instance_params["transaction_interest_free_expiry"] = dumps(
            {
                "balance_transfer": {
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_instance_parameter_change_event(
                        account_id="Main account",
                        timestamp=offset_datetime(2019, 2, 25, 0),
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_instance_parameter_change_event(
                        account_id="Main account",
                        timestamp=offset_datetime(2019, 1, 10, 0),
            ...
            SubTest(
                ...
                events=[
                    create_instance_parameter_change_event(
                        account_id="Main account",
                        timestamp=offset_datetime(2019, 1, 25, 0),
            ...
            SubTest(
                ...
                events=[
                    create_instance_parameter_change_event(
                        account_id="Main account",
                        timestamp=offset_datetime(2019, 2, 10, 0),
                        interest_free_expiry=dumps(
                            {
                                "cash_advance": "2020-12-31 00:00:00",
                                "transfer": "2020-12-31 00:00:00",
    ...
    def test_interest_free_period_combined_scenario_1(self):
        """
        Combined scenario to test the general behaviour of interet free periods
        ...
        sub_tests = [
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        ...
                        event_datetime=offset_datetime(2019, 1, 2, 12),
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 1, 2, 12): {
                        "Main account": [
                            (BalanceDimensions("DEFAULT"), Decimal("1000")),
                            (BalanceDimensions("AVAILABLE_BALANCE"), Decimal("9000")),
                            (
            ...
            SubTest(
                ...
                events=[
                    create_instance_parameter_change_event(
                        account_id="Main account",
                        timestamp=offset_datetime(2019, 1, 10, 0, 0, 1),
                        transaction_interest_free_expiry=dumps(
                ...
                expected_balances_at_ts={
                    offset_datetime(2019, 1, 10, 0, 0, 1): {
                        "Main account": [
                            (
                                BalanceDimensions("BALANCE_TRANSFER_REF1_INTEREST_BILLED"),
                                Decimal("0"),
            ...
            SubTest(
                ...
                events=[
                    create_instance_parameter_change_event(
                        account_id="Main account",
                        timestamp=offset_datetime(2019, 2, 10, 0, 0, 1),
                        transaction_interest_free_expiry=dumps(
                ...
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 10, 0, 0, 1): {
                        "Main account": [
                            (
                                BalanceDimensions("BALANCE_TRANSFER_REF1_INTEREST_BILLED"),
                                Decimal("0.90"),
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="100",
                        event_datetime=offset_datetime(2019, 2, 21, 13),
                    )
                ],
            ),
            SubTest(
                description="Checkpoint after PDD 1",
                # MAD paid off, uncharged interest free period interest zerod.
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 22, 12): {
                        "Main account": [
                            (
                                BalanceDimensions("AVAILABLE_BALANCE"),
                                Decimal("9099.10"),
            ...
            SubTest(
                ...
                events=[
                    create_instance_parameter_change_event(
                        account_id="Main account",
                        timestamp=offset_datetime(2019, 3, 10, 0, 0, 1),
                        transaction_interest_free_expiry=dumps(
                ...
                expected_balances_at_ts={
                    offset_datetime(2019, 3, 10, 0, 0, 1): {
                        "Main account": [
                            (
                                BalanceDimensions("BALANCE_TRANSFER_REF1_INTEREST_BILLED"),
                                Decimal("0.74"),
            ...
            SubTest(
                ...
                events=[
                    create_instance_parameter_change_event(
                        account_id="Main account",
                        timestamp=offset_datetime(2019, 3, 22, 0, 0, 1),
    ...
    def test_interest_free_period_combined_scenario_2_int_acc_from_scod(self):
        ...
        sub_tests = [
            ...
            SubTest(
                description="Repay MAD on time",
                # Pays off 100 on the princal for purchase
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="100",
                        event_datetime=offset_datetime(2019, 2, 21, 13),
        ...
        sub_tests = [
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        ...
                        event_datetime=offset_datetime(2019, 1, 2, 12, 0, 0, 1),
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 1, 2, 12, 0, 0, 1): {
                        "Main account": [
                            (BalanceDimensions("DEFAULT"), Decimal("1000")),
                            (BalanceDimensions("AVAILABLE_BALANCE"), Decimal("9000")),
                            (
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="1000",
                        event_datetime=offset_datetime(2019, 1, 2, 12, 0, 0, 2),
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 1, 2, 12, 0, 0, 2): {
                        "Main account": [
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        ...
                        event_datetime=offset_datetime(2019, 2, 26, 12, 0, 0, 1),
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 26, 12, 0, 0, 1): {
                        "Main account": [
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="1000",
                        event_datetime=offset_datetime(2019, 2, 26, 12, 0, 0, 2),
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 26, 12, 0, 0, 2): {
                        "Main account": [
    ...
    def test_charge_both_uncharged_addresses_when_revolver_starts(self):
        ...
        """
        start = offset_datetime(2019, 1, 1)
        end = offset_datetime(2019, 2, 22, 23)
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="2000",
                        event_datetime=offset_datetime(2019, 2, 21, 1),
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 21, 1): {
    ...
    def test_accrue_interest_from_txn_day_unchanged_in_repayment_holiday_started_before_scod(
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="1000", event_datetime=offset_datetime(2019, 1, 2)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 1, 2): {
            ...
            SubTest(
                ...
                events=[
                    create_flag_definition_event(
                        flag_definition_id="REPAYMENT_HOLIDAY",
                        timestamp=offset_datetime(2019, 1, 10),
                    ),
                    create_flag_event(
                        flag_definition_id="REPAYMENT_HOLIDAY",
                        account_id="Main account",
                        timestamp=offset_datetime(2019, 1, 10),
                        expiry_timestamp=offset_datetime(2019, 7, 10),
                    ),
                ],
            ),
