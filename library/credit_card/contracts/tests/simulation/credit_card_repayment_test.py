...
class CreditCardRepaymentTest(SimulationTestCase):
    ...
    def test_no_interest_acc_from_scod_is_charged_if_balance_paid_off_in_full_before_pdd(
        ...
        sub_tests = [
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="1000", event_datetime=offset_datetime(2019, 1, 11, 5)
                    )
                ],
            ),
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="2000", event_datetime=offset_datetime(2019, 2, 1, 1)
                    )
                ],
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="1100", event_datetime=offset_datetime(2019, 2, 5, 9)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 5, 9): {
                        "Main account": [
                            (
    ...
    def test_full_repayment_when_revolver_int_acc_from_scod(self):
        ...
        start = offset_datetime(2019, 1, 1)
        end = offset_datetime(2019, 2, 28, 3)
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="400",
                        event_datetime=offset_datetime(2019, 2, 27, 8),
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 27, 8): {
                        "Main account": [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="1800", event_datetime=offset_datetime(2019, 2, 28, 2)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 28, 2): {
                        "Main account": [
                            (BalanceDimensions("PURCHASE_UNPAID"), Decimal("0")),
                            (BalanceDimensions("MAD_BALANCE"), Decimal("200")),
                            (
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="35.44", event_datetime=offset_datetime(2019, 2, 28, 3)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 28, 3): {
                        "Main account": [
                            (BalanceDimensions("PURCHASE_UNPAID"), Decimal("0")),
                            (BalanceDimensions("MAD_BALANCE"), Decimal("200")),
                            (
    ...
    def test_full_repayment_when_revolver_int_acc_from_txn(self):
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="400", event_datetime=offset_datetime(2019, 2, 27, 8)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 27, 8): {
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="1800",
                        event_datetime=offset_datetime(2019, 2, 28, 2),
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 28, 2): {
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="76.36",
                        event_datetime=offset_datetime(2019, 2, 28, 3),
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 28, 3): {
    ...
    def test_pdd_schedule_is_not_affected_by_weekends(self):
        ...
        start = offset_datetime(year=2019, month=1, day=24)
        end = offset_datetime(year=2019, month=7, day=10, hour=1)

        instance_params = self.default_instance_params.copy()
        template_params = self.default_template_params.copy()

        instance_params = deepcopy(DEFAULT_CREDIT_CARD_INSTANCE_PARAMS)
        ...
        date_4 = start + timedelta(months=4, days=7)
        date_5 = start + timedelta(months=5, days=7)
    ...
    def test_all_pdds_on_last_day_of_month_if_first_pdd_is_on_last_day_of_month(self):
        ...
        start = offset_datetime(year=2019, month=2, day=10)
        end = offset_datetime(year=2019, month=7, day=10, hour=1)
    ...
    def test_next_pdd_not_affected_if_local_and_utc_month_different(self):
        ...
        start = offset_datetime(year=2019, month=1, day=8)
        end = offset_datetime(year=2019, month=4, day=10, second=2)
    ...
    def test_overdue_and_unpaid_rebalanced_correctly_for_fix_mad(self):
        ...
        start = offset_datetime(2019, 1, 1)
        end = offset_datetime(2019, 2, 26, 12)
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="500", event_datetime=offset_datetime(2019, 2, 26, 8)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 26, 8): {
                        "Main account": [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="716.5", event_datetime=offset_datetime(2019, 2, 26, 12)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 26, 12): {
                        "Main account": [
    ...
    def test_no_overdue_for_partial_repayment_above_fixed_mad_before_pdd(self):
        ...
        start = offset_datetime(2019, 1, 1)
        end = offset_datetime(2019, 2, 26, 1)
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="500", event_datetime=offset_datetime(2019, 2, 1, 2)
                    )
                ],
            ),
            SubTest(
    ...
    def test_deposit_balance_populated_when_overpaying_and_spent_from_first(self):
        ...
        instance_params["annual_fee"] = "800"
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="2000", event_datetime=offset_datetime(2019, 1, 1, 2)
                    )
                ],
                expected_balances_at_ts={
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="200", event_datetime=offset_datetime(2019, 1, 1, 4)
                    )
                ],
                expected_balances_at_ts={
    ...
    def test_deposit_balance_accounts_for_charged_interest_when_overpaying(self):
        ...
        start = offset_datetime(2019, 1, 1)
        end = offset_datetime(2019, 2, 24, 2)
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="11000", event_datetime=offset_datetime(2019, 2, 23, 2)
                    )
                ],
                expected_balances_at_ts={
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="500", event_datetime=offset_datetime(2019, 2, 24, 1)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 24, 1): {
                        "Main account": [
                            (
                                BalanceDimensions("AVAILABLE_BALANCE"),
                                Decimal("30355.24"),
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="1000", event_datetime=offset_datetime(2019, 2, 24, 2)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 24, 2): {
                        "Main account": [
                            (
                                BalanceDimensions("AVAILABLE_BALANCE"),
                                Decimal("29355.24"),
    ...
    def test_deposit_balance_unaffected_by_auth_and_used_when_over_settling_auth(self):
        ...
        start = offset_datetime(2019, 1, 1)
        end = offset_datetime(2019, 1, 3, 1)
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="15000", event_datetime=offset_datetime(2019, 1, 2, 1)
                    )
                ],
                expected_balances_at_ts={
    ...
    def test_repayment_hierarchy_no_late_fees(self):
        ...
        start = offset_datetime(2019, 1, 1)
        end = offset_datetime(2019, 4, 1, 0, 1)
            ...
            SubTest(
                ...
                events=[
                    ...
                    create_settlement_event(
                        ...
                        client_transaction_id="1",
                        final=True,
                        event_datetime=offset_datetime(2019, 1, 10, second=1),
                    ),
                ],
            ),
            SubTest(
                ...
                events=[
                    create_outbound_authorisation_instruction(
                        ...
                        event_datetime=offset_datetime(2019, 1, 15),
                    ),
                    create_settlement_event(
                        amount="3000",
                        client_transaction_id="2",
                        final=True,
                        event_datetime=offset_datetime(2019, 1, 15, second=1),
                    ),
                ],
            ),
            SubTest(
                ...
                events=[
                    ...
                    create_settlement_event(
                        ...
                        client_transaction_id="3",
                        final=True,
                        event_datetime=offset_datetime(2019, 1, 20, second=1),
                    ),
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                events=[
                    ...
                    create_settlement_event(
                        ...
                        client_transaction_id="4",
                        final=True,
                        event_datetime=offset_datetime(2019, 2, 10, second=1),
                    ),
                ],
            ),
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="50", event_datetime=offset_datetime(2019, 2, 22, 1)
                    )
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                events=[
                    ...
                    create_settlement_event(
                        ...
                        client_transaction_id="5",
                        final=True,
                        event_datetime=offset_datetime(2019, 3, 10, second=1),
                    ),
                ],
            ),
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="80", event_datetime=offset_datetime(2019, 3, 22, 1)
                    )
                ],
            ),
            SubTest(
    ...
    def test_repayment_hierarchy_late_repayment_overdue_charges(self):
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="50", event_datetime=offset_datetime(2019, 2, 25, 1)
                    )
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="80", event_datetime=offset_datetime(2019, 3, 25, 1)
                    )
                ],
            ),
            SubTest(
    ...
    def test_repayment_hierarchy_repay_under_mad_late_fees_billed(self):
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="1500", event_datetime=offset_datetime(2019, 2, 24, 1)
                    )
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="80", event_datetime=offset_datetime(2019, 2, 25, 1)
                    )
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="500", event_datetime=offset_datetime(2019, 3, 30, 1)
                    )
                ],
            ),
            SubTest(
    ...
    def test_repayment_hier_ca_int_billed_and_purchase_int_billed_and_chrgd(self):
        ...
        instance_params["credit_limit"] = "40000"
        instance_params["payment_due_period"] = "21"
        instance_params["overlimit"] = "0"
        instance_params["overlimit_fee"] = "0"
        instance_params["transaction_type_fees"] = dumps(
            {
                "cash_advance": {
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="300", event_datetime=offset_datetime(2019, 2, 25, 1)
                    )
                ],
            ),
            SubTest(
    ...
    def test_repayment_hierarchy_ca_repayment_purchase_interest_billed_and_charged(
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    ...
                    create_settlement_event(
                        ...
                        client_transaction_id="1",
                        final=True,
                        event_datetime=offset_datetime(2019, 2, 25, 2),
                    ),
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="1000", event_datetime=offset_datetime(2019, 3, 22, 1)
                    )
                ],
            ),
            SubTest(
    ...
    def test_pdd_considers_partial_repayment_after_cutoff(self):
        ...
        start = offset_datetime(2019, 1, 1)
        end = offset_datetime(2019, 2, 23, 0, 0, 1)
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="100",
                        event_datetime=offset_datetime(2019, 2, 23, 0, 0, 0, 1),
                    )
                ],
            ),
            SubTest(
                description="PDD 1",
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 23, 0, 0, 1): {
                        "Main account": [
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="1000",
                        event_datetime=offset_datetime(2019, 3, 1, 1),
                        instruction_details={"transaction_code": "aaa"},
                    )
                ],
                expected_balances_at_ts={
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="270", event_datetime=offset_datetime(2019, 4, 1, 1)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 4, 1, 1): {
    ...
    def test_repayment_hierarchy_fees_unpaid_fees_statement(self):
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="968.52", event_datetime=offset_datetime(2019, 4, 1, 1)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 4, 1, 1): {
    ...
    def test_repayment_hierarchy_ca_unpaid_ca_statement(self):
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="2088.52", event_datetime=offset_datetime(2019, 4, 1, 1)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 4, 1, 1): {
    ...
    def test_repayment_hierarchy_purchase_unpaid_purchase_statement(self):
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="7978.29", event_datetime=offset_datetime(2019, 4, 1, 1)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 4, 1, 1): {
    ...
    def test_repayment_hierarchy_int_unpaid_by_apr_int_statement_by_apr(self):
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="800", event_datetime=offset_datetime(2019, 4, 1, 1)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 4, 1, 1): {
    ...
    def test_repayment_hierarchy_ca_int_charged_purchase_int_charged(self):
        ...
        start = offset_datetime(2019, 1, 1)
        end = offset_datetime(2019, 4, 11, 1)
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="18157.52",
                        event_datetime=offset_datetime(2019, 4, 11, 1),
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 4, 11, 1): {
                        "Main account": [
    ...
    def test_txn_level_repayment_hierarchy(self):
        ...
        start = offset_datetime(2019, 1, 1)
        end = offset_datetime(2019, 1, 31, 7, 0, 0, 1)
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="10", event_datetime=offset_datetime(2019, 1, 31, 2)
                    )
                ],
                expected_balances_at_ts={
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="5000", event_datetime=offset_datetime(2019, 1, 31, 3)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 1, 31, 3): {
                        "Main account": [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="2000", event_datetime=offset_datetime(2019, 1, 31, 4)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 1, 31, 4): {
                        "Main account": [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="1000", event_datetime=offset_datetime(2019, 1, 31, 5)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 1, 31, 5): {
                        "Main account": [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="115.20", event_datetime=offset_datetime(2019, 1, 31, 6)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 1, 31, 6): {
                        "Main account": [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="59.10", event_datetime=offset_datetime(2019, 1, 31, 7)
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 1, 31, 7): {
                        "Main account": [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="108",
                        event_datetime=offset_datetime(2019, 1, 31, 7, 0, 0, 1),
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 1, 31, 7, 0, 0, 1): {
                        "Main account": [
                            (BalanceDimensions("DEFAULT"), Decimal("0")),
                            (BalanceDimensions("AVAILABLE_BALANCE"), Decimal("30000")),
                            (
    ...
    def test_payment_allowed_during_repayment_holiday(self):
        ...
        instance_params["transaction_type_limits"] = dumps({})
        instance_params["credit_limit"] = "5000"
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_flag_definition_event(
                        timestamp=offset_datetime(2019, 1, 2),
                    ...
                    create_flag_event(
                        ...
                        flag_definition_id="REPAYMENT_HOLIDAY",
                        account_id="Main account",
                        expiry_timestamp=offset_datetime(2019, 7, 2),
                    ),
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="500",
                        event_datetime=offset_datetime(2019, 2, 1, 2),
                    )
                ],
                expected_balances_at_ts={
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="400",
                        event_datetime=offset_datetime(2019, 2, 26, 2),
                    )
                ],
                expected_balances_at_ts={
                    offset_datetime(2019, 2, 26, 2): {
                        "Main account": [
                            (
                                BalanceDimensions("CASH_ADVANCE_BILLED"),
                                Decimal("279.70"),
