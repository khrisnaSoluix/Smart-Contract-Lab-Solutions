...
TRANSFER_FEE_INCOME_ACCOUNT = "balance_transfer_fee_income_internal_account"
TRANSFER_INTEREST_INCOME_ACCOUNT = "balance_transfer_interest_income_internal_account"
