...
class CreditCardStatementTest(SimulationTestCase):
    ...
    def test_int_billed_incl_accr_from_day_after_prev_scod_until_scod_incl_int_acc_from_scod(
        ...
        sub_tests = [
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="2000", event_datetime=datetime(2019, 1, 10, tzinfo=ZoneInfo("UTC"))
                    )
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    datetime(2019, 3, 1, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
    ...
    def test_statement_workflow_context_is_accurate(self):
        ...
        start = datetime(year=2018, month=1, day=1, tzinfo=ZoneInfo("UTC"))
        end = datetime(year=2018, month=4, day=1, hour=1, tzinfo=ZoneInfo("UTC"))

        instance_params = {**default_instance_params}
        template_params = {**default_template_params}

        # TODO: v3 test is inaccurate due to how run_times are checked for ExpectedWorkflow
        ...
        sub_tests = [
            SubTest(
                description="Check SCOD contract notifications triggered is correct",
    ...
    def test_auth_settlement_before_and_across_scod(self):
        start = datetime(2019, 1, 1, tzinfo=ZoneInfo("UTC"))
        end = datetime(2019, 3, 3, 1, tzinfo=ZoneInfo("UTC"))
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_outbound_authorisation_instruction(
                        ...
                        event_datetime=datetime(2019, 2, 20, 1, tzinfo=ZoneInfo("UTC")),
                    )
                ],
                expected_balances_at_ts={
                    datetime(2019, 2, 20, 1, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "AVAILABLE_BALANCE",
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    datetime(2019, 2, 22, 1, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "AVAILABLE_BALANCE",
    ...
    def test_outstanding_and_full_outstanding_updated_with_int_when_rev(self):
        start = datetime(2019, 1, 1, tzinfo=ZoneInfo("UTC"))
        end = datetime(2019, 4, 3, 1, tzinfo=ZoneInfo("UTC"))
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="399", event_datetime=datetime(2019, 1, 3, tzinfo=ZoneInfo("UTC"))
                    )
                ],
            ),
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="100", event_datetime=datetime(2019, 1, 15, tzinfo=ZoneInfo("UTC"))
                    )
                ],
                expected_balances_at_ts={
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="900", event_datetime=datetime(2019, 1, 31, tzinfo=ZoneInfo("UTC"))
                    )
                ],
            ),
            SubTest(
                description="SCOD 1",
                expected_balances_at_ts={
                    datetime(2019, 2, 1, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "AVAILABLE_BALANCE",
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    datetime(2019, 2, 16, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "AVAILABLE_BALANCE",
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="2000", event_datetime=datetime(2019, 2, 27, tzinfo=ZoneInfo("UTC"))
                    )
                ],
            ),
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="1000", event_datetime=datetime(2019, 2, 28, tzinfo=ZoneInfo("UTC"))
                    )
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="900",
                        event_datetime=datetime(2019, 3, 2, tzinfo=ZoneInfo("UTC")),
                    )
                ],
            ),
            SubTest(
                ...
                "outstanding",
                expected_balances_at_ts={
                    datetime(2019, 3, 3, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "AVAILABLE_BALANCE",
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="1000", event_datetime=datetime(2019, 3, 15, tzinfo=ZoneInfo("UTC"))
                    )
                ],
            ),
            SubTest(
                ...
                "outstanding",
                expected_balances_at_ts={
                    datetime(2019, 3, 16, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "AVAILABLE_BALANCE",
            ...
            SubTest(
                description="SCOD 3",
                expected_balances_at_ts={
                    datetime(2019, 4, 1, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "AVAILABLE_BALANCE",
            ...
            SubTest(
                ...
                "outstanding",
                expected_balances_at_ts={
                    datetime(2019, 4, 3, 1, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "AVAILABLE_BALANCE",
    ...
    def test_overdue_amounts_calculated_and_repaid_correctly_multi_purchase(self):
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="50", event_datetime=datetime(2019, 3, 22, 1, tzinfo=ZoneInfo("UTC"))
                    )
                ],
                expected_balances_at_ts={
                    datetime(2019, 3, 22, 1, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "MAD_BALANCE",
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="500",
                        event_datetime=datetime(2019, 4, 10, 1, tzinfo=ZoneInfo("UTC")),
                    )
                ],
            ),
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="100",
                        event_datetime=datetime(2019, 4, 22, 1, tzinfo=ZoneInfo("UTC")),
                    )
                ],
                expected_balances_at_ts={
                    datetime(2019, 4, 22, 1, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "MAD_BALANCE",
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="1000",
                        event_datetime=datetime(2019, 5, 10, 1, tzinfo=ZoneInfo("UTC")),
                    )
                ],
            ),
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="100",
                        event_datetime=datetime(2019, 5, 22, 1, tzinfo=ZoneInfo("UTC")),
                    )
                ],
                expected_balances_at_ts={
                    datetime(2019, 5, 22, 1, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "MAD_BALANCE",
    ...
    def test_overdue_amounts_calc_and_repaid_correctly_single_purchase(self):
        start = datetime(2019, 1, 1, tzinfo=ZoneInfo("UTC"))
        end = datetime(2019, 5, 1, 1, tzinfo=ZoneInfo("UTC"))
        ...
        sub_tests = [
            ...
            SubTest(
                description="PDD 3",
                expected_balances_at_ts={
                    datetime(2019, 4, 23, 1, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "MAD_BALANCE",
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="1000",
                        event_datetime=datetime(2019, 4, 23, 2, tzinfo=ZoneInfo("UTC")),
                    )
                ],
                expected_balances_at_ts={
                    datetime(2019, 4, 23, 2, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "MAD_BALANCE",
    ...
    def test_statement_balances(self):
        start = datetime(2019, 1, 1, tzinfo=ZoneInfo("UTC"))
        end = datetime(2019, 4, 1, 0, 1, 0, tzinfo=ZoneInfo("UTC"))
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_settlement_event(
                        amount="10000",
                        event_datetime=datetime(2019, 1, 3, 0, 0, 0, 1, tzinfo=ZoneInfo("UTC")),
                        final=True,
                        client_transaction_id="1234",
                    )
                ],
            ...
            SubTest(
                ...
                events=[
                    create_settlement_event(
                        amount="2000",
                        event_datetime=datetime(2019, 1, 5, 0, 0, 0, 1, tzinfo=ZoneInfo("UTC")),
                        final=True,
                        client_transaction_id="2345",
                    )
                ],
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="2000",
                        event_datetime=datetime(2019, 2, 5, tzinfo=ZoneInfo("UTC")),
                    )
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                events=[
                    create_settlement_event(
                        amount="5000",
                        event_datetime=datetime(2019, 2, 10, 2, 0, 0, 1, tzinfo=ZoneInfo("UTC")),
                        final=True,
                        client_transaction_id="3456",
                    )
                ],
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    datetime(2019, 4, 1, 0, 1, 0, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "AVAILABLE_BALANCE",
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_settlement_event(
                        amount="5000",
                        event_datetime=datetime(2019, 2, 10, 2, tzinfo=ZoneInfo("UTC")),
                        final=True,
                        client_transaction_id="3456",
                    )
                ],
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_settlement_event(
                        amount="1000",
                        event_datetime=datetime(2019, 1, 1, 0, 0, 0, 1, tzinfo=ZoneInfo("UTC")),
                        final=True,
                        client_transaction_id="1234",
                    )
                ],
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_settlement_event(
                        amount="22000",
                        event_datetime=datetime(2019, 1, 2, 0, 0, 0, 1, tzinfo=ZoneInfo("UTC")),
                        final=True,
                        client_transaction_id="2",
                    )
                ],
            ...
            SubTest(
                ...
                events=[
                    create_settlement_event(
                        amount="3000",
                        event_datetime=datetime(2019, 2, 28, 2, 0, 0, 1, tzinfo=ZoneInfo("UTC")),
                        final=True,
                        client_transaction_id="3",
                    )
                ],
    ...
    def test_mad_with_overdue(self):
        start = datetime(2019, 1, 1, tzinfo=ZoneInfo("UTC"))
        end = datetime(2019, 3, 1, 0, 1, 0, tzinfo=ZoneInfo("UTC"))
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    datetime(2019, 3, 1, 0, 1, 0, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "MAD_BALANCE",
    ...
    def test_mad_outstanding_exceeds_overlimit(self):
        start = datetime(2019, 1, 1, tzinfo=ZoneInfo("UTC"))
        end = datetime(2019, 6, 1, 0, 1, 0, tzinfo=ZoneInfo("UTC"))
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_settlement_event(
                        amount="10000",
                        event_datetime=datetime(2019, 1, 10, 0, 0, 0, 1, tzinfo=ZoneInfo("UTC")),
                        final=True,
                        client_transaction_id="2",
                    )
                ],
            ...
            SubTest(
                ...
                events=[
                    create_settlement_event(
                        amount="18000",
                        event_datetime=datetime(2019, 1, 20, 2, 0, 0, 1, tzinfo=ZoneInfo("UTC")),
                        final=True,
                        client_transaction_id="3",
                    )
                ],
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    datetime(2019, 5, 1, 0, 1, 0, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "MAD_BALANCE",
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="300",
                        event_datetime=datetime(2019, 5, 21, 1, tzinfo=ZoneInfo("UTC")),
                    )
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    datetime(2019, 6, 1, 0, 1, 0, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "MAD_BALANCE",
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_settlement_event(
                        amount="700",
                        event_datetime=datetime(2019, 1, 20, 0, 0, 0, 1, tzinfo=ZoneInfo("UTC")),
                        final=True,
                        client_transaction_id="3",
                    )
                ],
            ...
            SubTest(
                ...
                events=[
                    create_settlement_event(
                        amount="1000",
                        event_datetime=datetime(2019, 2, 5, 0, 0, 0, 1, tzinfo=ZoneInfo("UTC")),
                        final=True,
                        client_transaction_id="5",
                    )
                ],
            ...
            SubTest(
                ...
                events=[
                    create_settlement_event(
                        amount="1500",
                        event_datetime=datetime(2019, 2, 10, 0, 0, 0, 1, tzinfo=ZoneInfo("UTC")),
                        final=True,
                        client_transaction_id="6",
                    )
                ],
            ...
            SubTest(
                ...
                events=[
                    create_settlement_event(
                        amount="1000",
                        event_datetime=datetime(2019, 3, 1, 2, 0, 0, 1, tzinfo=ZoneInfo("UTC")),
                        final=True,
                        client_transaction_id="7",
                    )
                ],
            ...
            SubTest(
                ...
                events=[
                    create_settlement_event(
                        amount="300",
                        event_datetime=datetime(2019, 3, 10, 0, 0, 0, 1, tzinfo=ZoneInfo("UTC")),
                        final=True,
                        client_transaction_id="8",
                    )
                ],
            ...
            SubTest(
                ...
                events=[
                    create_outbound_authorisation_instruction(
                        ...
                        event_datetime=datetime(2019, 4, 10, tzinfo=ZoneInfo("UTC")),
                    )
                ],
            ),
            SubTest(
                ...
                events=[
                    create_settlement_event(
                        amount="500",
                        event_datetime=datetime(2019, 4, 10, 0, 0, 0, 1, tzinfo=ZoneInfo("UTC")),
                        final=True,
                        client_transaction_id="9",
                    )
                ],
            ...
            SubTest(
                ...
                events=[
                    create_outbound_authorisation_instruction(
                        ...
                        event_datetime=datetime(2019, 5, 10, tzinfo=ZoneInfo("UTC")),
                    )
                ],
            ),
            SubTest(
                ...
                events=[
                    create_settlement_event(
                        ...
                        client_transaction_id="10",
                        final=True,
                        event_datetime=datetime(2019, 5, 10, 0, 0, 0, 1, tzinfo=ZoneInfo("UTC")),
                    )
                ],
            ),
            SubTest(
        ...
        sub_tests = [
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        ...
                        event_datetime=datetime(
                            2019, 2, 1, 0, 0, 0, tzinfo=ZoneInfo("UTC")
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="2000",
                        event_datetime=datetime(
                            2019, 2, 1, 0, 0, 0, 1, tzinfo=ZoneInfo("UTC")
                        ),  # SCOD runs at 2 secs past
                    )
                ],
            ),
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="1000",
                        event_datetime=datetime(2019, 2, 28, 0, tzinfo=ZoneInfo("UTC")),
                    )
                ],
                expected_balances_at_ts={
                    datetime(2019, 2, 28, 0, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "PURCHASE_CHARGED",
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="2000",
                        event_datetime=datetime(
                            2019, 3, 1, 0, 0, 1, tzinfo=ZoneInfo("UTC")
                        ),  # SCOD runs at 2 secs past
                    )
                ],
            ),
            SubTest(
                ...
                expected_balances_at_ts={
                    datetime(2019, 3, 1, 0, 0, 2, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "STATEMENT_BALANCE",
    ...
    def test_statement_balance_when_repayments_exceed_spend_and_charges(self):
        ...
        instance_params = {
            **default_instance_params,
            ...
            "transaction_type_limits": dumps({"cash_advance": {"flat": "20000"}}),
            "late_repayment_fee": "0",
            "annual_fee": "0",
        }
        template_params = {
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_inbound_hard_settlement_instruction(
                        amount="20000",
                        event_datetime=datetime(2019, 1, 25, 2, tzinfo=ZoneInfo("UTC")),
                    )
                ],
            ),
            SubTest(
    ...
    def test_mad_rounding_int_acc_from_scod(self):
        start = datetime(2019, 1, 1, tzinfo=ZoneInfo("UTC"))
        end = datetime(2019, 3, 2, 1, tzinfo=ZoneInfo("UTC"))
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="4000.25",
                        instruction_details={"transaction_code": "aaa"},
                        event_datetime=datetime(2019, 1, 31, 20, tzinfo=ZoneInfo("UTC")),
                    )
                ],
            ),
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        ...
                        event_datetime=datetime(2019, 1, 31, 21, tzinfo=ZoneInfo("UTC")),
                    )
                ],
            ),
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        ...
                        event_datetime=datetime(2019, 1, 31, 22, tzinfo=ZoneInfo("UTC")),
                    )
                ],
            ),
            SubTest(
            ...
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="2000.25",
                        event_datetime=datetime(2019, 2, 1, 10, tzinfo=ZoneInfo("UTC")),
                    )
                ],
            ),
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="4000.25",
                        instruction_details={"transaction_code": "aaa"},
                        event_datetime=datetime(2019, 2, 21, 20, tzinfo=ZoneInfo("UTC")),
                    )
                ],
            ),
            SubTest(
    ...
    def test_mad_disregarded_if_repayment_holiday_set_before_scod_and_statement_generated(
        ...
        start = datetime(2019, 1, 1, tzinfo=ZoneInfo("UTC"))
        end = datetime(2019, 2, 26, 0, 1, tzinfo=ZoneInfo("UTC"))
        ...
        # TODO: Date incorrect in v3 test
        date_1 = start + relativedelta(months=1, seconds=2)
        ...
        sub_tests = [
            SubTest(
                ...
                events=[
                    create_outbound_hard_settlement_instruction(
                        amount="500",
                        event_datetime=datetime(2019, 1, 25, 1, tzinfo=ZoneInfo("UTC")),
                    )
                ],
                expected_balances_at_ts={
                    datetime(2019, 1, 25, 1, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "DEFAULT",
            ...
            SubTest(
                ...
                events=[
                    create_flag_definition_event(
                        ...
                        timestamp=datetime(2019, 1, 26, tzinfo=ZoneInfo("UTC")),
                    ),
                    create_flag_event(
                        flag_definition_id="REPAYMENT_HOLIDAY",
                        account_id="Main account",
                        timestamp=datetime(2019, 1, 26, tzinfo=ZoneInfo("UTC")),
                        expiry_timestamp=datetime(2019, 7, 26, tzinfo=ZoneInfo("UTC")),
                    ),
                ],
            ),
            SubTest(
            ...
            SubTest(
                description="Check SCOD notifcation triggered is correct",
                expected_contract_notifications=[
                    ExpectedContractNotification(
                        notification_type=PUBLISH_STATEMENT_DATA_NOTIFICATION,
                        resource_type=ContractNotificationResourceType.RESOURCE_ACCOUNT,
    ...
    def test_billed_balance_unaffected_and_overdue_not_aged_on_pdd_but_resumes_after_RH_end(
        ...
        """
        start = datetime(2019, 1, 1, tzinfo=ZoneInfo("UTC"))
        end = datetime(2019, 7, 25, 0, 1, tzinfo=ZoneInfo("UTC"))
        ...
        sub_tests = [
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    datetime(2019, 1, 25, 2, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "DEFAULT",
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    datetime(2019, 4, 25, 0, 1, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "PURCHASE_UNPAID",
            ...
            SubTest(
                ...
                events=[
                    create_flag_definition_event(
                        flag_definition_id="REPAYMENT_HOLIDAY",
                        timestamp=datetime(2019, 4, 26, tzinfo=ZoneInfo("UTC")),
                    ),
                    create_flag_event(
                        flag_definition_id="REPAYMENT_HOLIDAY",
                        account_id="Main account",
                        timestamp=datetime(2019, 4, 26, tzinfo=ZoneInfo("UTC")),
                        expiry_timestamp=datetime(2019, 6, 26, tzinfo=ZoneInfo("UTC")),
                    ),
                ],
                expected_balances_at_ts={
                    datetime(2019, 4, 26, 1, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions("CASH_ADVANCE_INTEREST_CHARGED"),
                                Decimal("12.25"),
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    datetime(2019, 4, 27, 1, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions("CASH_ADVANCE_INTEREST_CHARGED"),
                                Decimal("12.74"),
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    datetime(2019, 5, 1, 0, 1, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "PURCHASE_UNPAID",
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    datetime(2019, 5, 25, 0, 1, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "PURCHASE_UNPAID",
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    datetime(2019, 6, 25, 0, 1, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "PURCHASE_UNPAID",
            ...
            SubTest(
                ...
                expected_balances_at_ts={
                    datetime(2019, 7, 25, 0, 1, tzinfo=ZoneInfo("UTC")): {
                        "Main account": [
                            (
                                BalanceDimensions(
                                    "PURCHASE_UNPAID",
