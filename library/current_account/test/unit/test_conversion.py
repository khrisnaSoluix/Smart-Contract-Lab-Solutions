...
from library.current_account.test.unit.current_account_common import CurrentAccountTest
...
class ConversionTest(CurrentAccountTest):
    def test_conversion_passes_schedules_through(self):
        ...
        hook_result = current_account.conversion_hook(
