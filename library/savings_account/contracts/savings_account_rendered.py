...
#    savings_account.py
# md5:abd248e22bb05ad56954da6ee1d5aa57
...
def deactivation_hook(
    ...
    if dormancy_is_account_dormant(
    ...
    posting_instructions = tiered_interest_accrual_get_interest_reversal_postings(
        vault=vault,
...
def scheduled_event_hook(
    ...
    if event_type == tiered_interest_accrual_ACCRUAL_EVENT:
        ...
        if inactivity_fee_is_account_inactive(vault=vault, effective_datetime=effective_datetime):
            posting_instructions.extend(
                inactivity_fee_apply(vault=vault, effective_datetime=effective_datetime)
            )
...
FEE_HIERARCHY = [minimum_monthly_balance_PARTIAL_FEE_DETAILS, inactivity_fee_PARTIAL_FEE_DETAILS]
